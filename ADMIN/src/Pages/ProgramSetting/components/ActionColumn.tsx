...
interface ActionColumnProps {
  ...
  setcurrentIdProgram: (id: string) => void
}

function ActionColumn({ id, setOpenDialog, setcurrentIdProgram }: ActionColumnProps) {
  ...
  const handleConfirmDelete = () => {
    dispatch(AdvReduxActions.DeleteProgramRequest({ id }))
