...
export const SearchAdvSettingSchema = yup.object({
  [ADV_SETTING_FIELD_NAME.SEARCH]: yup.string(),
  [ADV_SETTING_FIELD_NAME.POSITION_ADV]: yup.string(),
  [ADV_SETTING_FIELD_NAME.PACKAGE_ADV]: yup.string(),
  [ADV_SETTING_FIELD_NAME.STATUS]: yup.string(),
  [ADV_SETTING_FIELD_NAME.START_DATE]: yup.string(),
  [ADV_SETTING_FIELD_NAME.END_DATE]: yup.string()
})
