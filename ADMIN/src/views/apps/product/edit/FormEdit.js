...
const FormCreate = () => {
  ...
  useEffect(() => {
    if (storeProduct.data.length > 0) {
      ...
      data?.paragraphUK && setParagraphUK(JSON.parse(data?.paragraphUK))
      data?.paragraphUS && setParagraphUS(JSON.parse(data?.paragraphUS))
      data?.paragraphFR && setParagraphFR(JSON.parse(data?.paragraphFR))
      data?.paragraphDE && setParagraphDE(JSON.parse(data?.paragraphDE))
